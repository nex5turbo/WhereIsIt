             ...
             return SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  const Text('Here', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                ],
              ),
            );
          },
              ...
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: Icon(
                        isInUse ? Icons.warning_amber_rounded : Icons.check_circle_outline,
                        color: isInUse ? Colors.red : Colors.green,
                      ),
                      title: Text(item.name, style: TextStyle(
                        decoration: isInUse ? TextDecoration.lineThrough : null, // stylistic choice? Or maybe "In Use" should be highlighted.
                      ...
                      trailing: Switch(
                        ...
                        onChanged: (val) async {
                           final newStatus = val ? ItemStatus.stored : ItemStatus.inUse;
                           await ref.read(itemRepositoryProvider).toggleStatus(item.id, newStatus);
                           ref.invalidate(itemsInSpaceProvider(parentId!)); // refresh
                        },
                      ),
                    ),
                  );
